...
class AddGoods implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        category.getSelectionModel().selectedItemProperty().addListener((options, oldValue, newValue) -> indexVBox.setVisible(newValue.equals("Produce") || newValue.equals("Cleaner") || newValue.equals("Paper") || newValue == "Personal"));
    }
